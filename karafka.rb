...
class KarafkaApp < Karafka::App
  setup do |config|
    ...
    config.client_id = "ecommerce-rails-#{Process.pid}-#{Socket.gethostname}"
    config.group_id = "ecommerce_rails_consumer"
  ...
  routes.draw do
    topic :"orders.failed" do
      consumer OrdersFailedConsumer
    end

    topic :"orders.processed" do
      consumer OrdersProcessedConsumer
    end
  end
end
